    ...
    public sealed class ProgressDashboard : EditorWindow
    {
        ...
        private static List<FeatureEntry> BuildRegistry()
        {
            ...
            return new List<FeatureEntry>
            {
                ...
                new FeatureEntry { domain = "Campaign", name = "KIA hook + legacy successor + Personalization binders (B3)", status = FeatureStatus.InIntegration, note = "B3 agent running",
                    keyPaths = new string[0] },
